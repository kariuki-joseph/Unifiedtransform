...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-calendar4-range"></i> Timetable</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Classes</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Timetable - {{ $section_name }}</li>
                        </ol>
                    </nav>
                    @php
                    ...
                    @else
                    <div class="p-3 bg-white border shadow-sm">No timetable.</div>
                    @endif
                </div>
            </div>
