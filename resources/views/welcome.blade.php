...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Professor High School</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <h1 class="text-gray-900 dark:text-white"><img src="{{asset('favicon_io/P.jpeg')}}" class="mr-2" height="50px" width="50px"><span style="font-size: 45px; color: #8a6dd9;">rofessor High School </span> </h1>
