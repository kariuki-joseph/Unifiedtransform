                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light">
                                <form action="{{route('exam.grade.system.rule.store')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputPoint" class="form-label">Points<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="number" step="0.01" name="point" class="form-control" id="inputPoint" placeholder="12, 11, 10, ...">
                                    </div>
