...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-journal-medical"></i> Edit Subject</h1>
                    ...
                    <div class="row">
                        <form class="col-6" action="{{route('school.course.update')}}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="course_type" class="form-label">Subject Type</label>
                                <select class="form-select" id="course_type" name="course_type" aria-label="Subject type">
